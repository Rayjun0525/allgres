...
-- Applied with: ALTER EXTENSION allgres UPDATE TO '0.5.0';

-- Native (Rust, `#[pg_extern]`) function declarations, extracted from
-- the fresh-install file pgrx just generated (/usr/share/postgresql/16/extension/allgres--0.5.0.sql) and
-- rewritten as CREATE OR REPLACE -- see this script's own header comment.
CREATE OR REPLACE FUNCTION allgres."analyze_sql"(
	"sql" TEXT /* & str */
) RETURNS jsonb /* JsonB */
...
CREATE OR REPLACE FUNCTION allgres."native_host_stats"() RETURNS jsonb /* JsonB */
STRICT
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'native_host_stats_wrapper';

CREATE OR REPLACE FUNCTION allgres."native_status"() RETURNS jsonb /* JsonB */
STRICT
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'native_status_wrapper';

CREATE OR REPLACE FUNCTION allgres."native_version"() RETURNS TEXT /* & '_ str */
STRICT
LANGUAGE c /* Rust */
