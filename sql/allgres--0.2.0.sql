...
/* <begin connected objects> */
-- src/lib.rs:89
CREATE SCHEMA IF NOT EXISTS allgres; /* allgres::allgres */
/* </end connected objects> */

/* <begin connected objects> */
-- src/lib.rs:103
-- allgres::allgres::analyze_sql
CREATE  FUNCTION allgres."analyze_sql"(
	"sql" TEXT /* & str */
) RETURNS jsonb /* JsonB */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'analyze_sql_wrapper';
/* </end connected objects> */

/* <begin connected objects> */
-- src/lib.rs:108
-- allgres::allgres::native_status
CREATE  FUNCTION allgres."native_status"() RETURNS jsonb /* JsonB */
STRICT
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'native_status_wrapper';
/* </end connected objects> */

/* <begin connected objects> */
-- src/lib.rs:93
-- allgres::allgres::native_version
CREATE  FUNCTION allgres."native_version"() RETURNS TEXT /* & '_ str */
STRICT
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'native_version_wrapper';
/* </end connected objects> */
...
-- Allgres 0.2.0 base install script (frozen).
--
-- This is a snapshot of sql/control_plane.sql exactly as it stood at the end
-- of 0.2.0 development (git tag/commit 12e1df7) -- the first point this
-- project ever captured a real, installable prior version rather than
-- treating "0.1.0 -> 0.2.0" as a copy of whatever control_plane.sql
-- currently says (which is what it always was before this file existed: see
-- KNOWN_ISSUES.md, "extension upgrade path"). Do not edit this file going
-- forward -- it exists so `CREATE EXTENSION allgres VERSION '0.2.0'` and
-- `ALTER EXTENSION allgres UPDATE TO` a later version are both real,
-- testable operations against an actual prior schema, not aspirational
-- ones. The next base freeze happens the same way, at the next version bump.
--
