...
-- ON CONFLICT DO NOTHING), which just means a fresh install can replay it
-- safely -- this project has never shipped a real release, so there is no
-- upgrade path to maintain.
--
